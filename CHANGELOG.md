...
## [1.2.2](https://github.com/artkay/fakerer/compare/v1.2.1...v1.2.2) (2026-07-30)

### Changed

- `Faker.Util.list/2` - add doctests covering lengths `0` and `1`, adopted from upstream ([elixirs/faker#613](https://github.com/elixirs/faker/pull/613)) [[@ypconstante](https://github.com/ypconstante)]
- Drop the unused `earmark` dev dependency ([elixirs/faker#651](https://github.com/elixirs/faker/pull/651))

### Removed

- Drop `makeup` and `makeup_elixir` as runtime dependencies ([elixirs/faker#683](https://github.com/elixirs/faker/pull/683)) [[@ypconstante](https://github.com/ypconstante)]
...
- `Faker.Address.Da`, `Faker.Company.Da`, `Faker.Person.Da`, `Faker.Phone.Da` - Danish locale support [[@Munksgaard](https://github.com/Munksgaard)]
...
- `Faker.Gov.It.fiscal_id/0` - fix fiscal code generation [[@CostantiniMatteo](https://github.com/CostantiniMatteo)]
